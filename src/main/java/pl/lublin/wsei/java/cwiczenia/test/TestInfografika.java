...
public class TestInfografika {
    public static void main(String[] args) {
        String tekst = "<item>\n" +
                ...
                "\t\t</item>";
        Infografika t = new Infografika(tekst);
        System.out.println("Infografika: \nTytuł: "+t.tytul+"\nAdres strony: " + t.adresStrony +"\nAdres grafiki: "+t.adresGrafiki+"\nAdres miniaturki: "+ t.adresMiniaturki+"\nRozmiary: "+t.szerokosc+"x"+t.wysokosc);
    }
}
